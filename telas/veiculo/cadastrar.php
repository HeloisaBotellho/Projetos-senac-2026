...
<html lang="pt-br">
  <head>
    ...
    <title>Cadastrar Veículo - CargoTech</title>
          ...
          <div class="card bg-glass">
            <div class="card-body px-4 py-5 px-md-5">
              <form method="POST">
                ...
                <div class="row">
                <h4 class="mb-5 text-left"><strong>Dados do Veículo:</strong></h4>

                <div data-mdb-input-init class="form-outline mb-4">   
                    <input type="text" id="form3Example3" class="form-control" name="tipo"/>
                    <label class="form-label" for="form3Example3">Tipo: </label>
                </div>
  
                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="text" id="form3Example4" class="form-control" name="modelo"/>
                  <label class="form-label" for="form3Example4">Modelo: </label>
                </div>

                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="date" id="form3Example4" class="form-control" name="ano"/>
                  <label class="form-label" for="form3Example4">Ano: </label>
                </div>

                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="color" id="form3Example4" class="form-control" name="cor" />
                  <label class="form-label" for="form3Example4">Cor: </label>
                </div>

                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="text" id="form3Example4" class="form-control" name="placa" pattern="[A-Z]{3}[0-9][A-Z0-9][0-9]{2}" title="Formato válido: ABC1D23 ou ABC1234" style="text-transform: uppercase;"/>
