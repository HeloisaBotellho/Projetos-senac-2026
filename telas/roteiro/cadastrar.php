...
<html lang="pt-br">
  <head>
    ...
    <title>CargoTech - Cadastrar Roteiro</title>
    ...
    <div class="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
      <div class="row gx-lg-5 align-items-center mb-5">
        <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
          ...
          Cadastro de Roteiros<br />
            <span style="color: hsl(218, 81%, 75%)">rápido e simples</span>
          </h1>
          <p class="mb-4 opacity-70" style="color: hsl(218, 81%, 85%)">
            Organize suas rotas de entrega com praticidade e precisão.<br><br>

            Cadastre roteiros definindo regiões, dias e responsáveis,
            garantindo uma operação mais ágil e bem estruturada.<br><br>

            Um bom planejamento de rotas reduz custos, otimiza tempo
          ...
          <div class="card bg-glass">
            <div class="card-body px-4 py-5 px-md-5">
              <form method="POST">
                ...
                <div class="row">
                <h4 class="mb-5 text-left"><strong>Dados do Rota:</strong></h4>

                <!-- Email input -->
                <div data-mdb-input-init class="form-outline mb-4">
                    
                    <input type="text" id="form3Example3" class="form-control" name="regiao"/>
                    <label class="form-label" for="form3Example3">Região: </label>
                </div>
  
                <!-- Password input -->
                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="text" id="form3Example4" class="form-control" name="dia"/>
                  <label class="form-label" for="form3Example4">Dia: </label>
                </div>
